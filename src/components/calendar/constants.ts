...
export const RAID_CONFIG: Record<string, RaidConfig> = {
  ...
  serpentshrine: {
    label: 'Caverna Santuario Serpiente (SSC)',
    capacity: 25,
    accentColor: '#1a9e9e',
    borderColor: 'rgba(26, 158, 158, 0.6)',
    glowColor: 'rgba(26, 158, 158, 0.2)',
    description: 'Lady Vashj · 25 jugadores',
    bgGradient: 'linear-gradient(135deg, rgba(0,120,120,0.18) 0%, rgba(0,60,80,0.10) 50%, transparent 100%)',
    image: '/raid-ssc.webp',
  },
  tempestkeep: {
    label: 'Castillo de la tempestad (TK)',
    capacity: 25,
    accentColor: '#a066cc',
    borderColor: 'rgba(160, 102, 204, 0.6)',
    glowColor: 'rgba(160, 102, 204, 0.2)',
    description: "Kael'thas Sunstrider · 25 jugadores",
    bgGradient: 'linear-gradient(135deg, rgba(100,40,160,0.18) 0%, rgba(60,20,100,0.10) 50%, transparent 100%)',
    image: '/raid-tk.webp',
  },
  custom: {
    label: "Evento Custom",
